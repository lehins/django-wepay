...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('djwepay_preapproval', 'shipping_address')

        # Deleting field 'Checkout.shipping_address'
        db.delete_column('djwepay_checkout', 'shipping_address')
