...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.theme_object'
        db.add_column('djwepay_account', 'theme_object',
                      self.gf('json_field.fields.JSONField')(default=u'null', blank=True),
                      keep_default=False)

        # Adding field 'Account.gaq_domains'
        db.add_column('djwepay_account', 'gaq_domains',
                      self.gf('json_field.fields.JSONField')(default=u'null', blank=True),
                      keep_default=False)

        # Adding field 'Account.image_uri'
        db.add_column('djwepay_account', 'image_uri',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Account.mcc'
        db.add_column('djwepay_account', 'mcc',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.theme_object'
        db.delete_column('djwepay_account', 'theme_object')

        # Deleting field 'Account.gaq_domains'
        db.delete_column('djwepay_account', 'gaq_domains')

        # Deleting field 'Account.image_uri'
        db.delete_column('djwepay_account', 'image_uri')

        # Deleting field 'Account.mcc'
        db.delete_column('djwepay_account', 'mcc')
