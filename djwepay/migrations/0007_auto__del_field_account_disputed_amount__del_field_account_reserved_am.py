...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Account.disputed_amount'
        db.delete_column(u'djwepay_account', 'disputed_amount')

        # Deleting field 'Account.reserved_amount'
        db.delete_column(u'djwepay_account', 'reserved_amount')

        # Deleting field 'Account.available_balance'
        db.delete_column(u'djwepay_account', 'available_balance')

        # Deleting field 'Account.pending_balance'
        db.delete_column(u'djwepay_account', 'pending_balance')

        # Deleting field 'Account.pending_amount'
        db.delete_column(u'djwepay_account', 'pending_amount')


    def backwards(self, orm):
        # Adding field 'Account.disputed_amount'
        db.add_column(u'djwepay_account', 'disputed_amount',
                      self.gf('djwepay.fields.MoneyField')(default=0, max_digits=11, decimal_places=2),
                      keep_default=False)

        # Adding field 'Account.reserved_amount'
        db.add_column(u'djwepay_account', 'reserved_amount',
                      self.gf('djwepay.fields.MoneyField')(default=0, max_digits=11, decimal_places=2),
                      keep_default=False)

        # Adding field 'Account.available_balance'
        db.add_column(u'djwepay_account', 'available_balance',
                      self.gf('djwepay.fields.MoneyField')(default=0, max_digits=11, decimal_places=2),
                      keep_default=False)

        # Adding field 'Account.pending_balance'
        db.add_column(u'djwepay_account', 'pending_balance',
                      self.gf('djwepay.fields.MoneyField')(default=0, max_digits=11, decimal_places=2),
                      keep_default=False)

        # Adding field 'Account.pending_amount'
        db.add_column(u'djwepay_account', 'pending_amount',
                      self.gf('djwepay.fields.MoneyField')(default=0, max_digits=11, decimal_places=2),
                      keep_default=False)
    ...
    models = {
        ...
        u'djwepay.account': {
            ...
            'image_uri': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
