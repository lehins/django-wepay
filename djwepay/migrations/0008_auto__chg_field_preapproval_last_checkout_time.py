...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Preapproval.last_checkout_time'
        db.alter_column('djwepay_preapproval', 'last_checkout_time', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Preapproval.last_checkout_time'
        raise RuntimeError("Cannot reverse this migration. 'Preapproval.last_checkout_time' and its values cannot be restored.")
