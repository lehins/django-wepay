...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('djwepay_app', (
            ...
            ('theme_object', self.gf('json_field.fields.JSONField')(default=u'null', blank=True)),
            ('gaq_domains', self.gf('json_field.fields.JSONField')(default=u'null', blank=True)),
            ...
            ('production', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'djwepay', ['App'])


    def backwards(self, orm):
        # Deleting model 'App'
        db.delete_table('djwepay_app')
