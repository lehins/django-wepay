...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'djwepay_address')


        # Changing field 'Account.reserved_amount'
        db.alter_column('djwepay_account', 'reserved_amount', self.gf('djwepay.fields.MoneyField')(max_digits=11, decimal_places=2))

        # Changing field 'Account.payment_limit'
        db.alter_column('djwepay_account', 'payment_limit', self.gf('djwepay.fields.MoneyField')(null=True, max_digits=11, decimal_places=2))

        # Changing field 'Account.disputed_amount'
        db.alter_column('djwepay_account', 'disputed_amount', self.gf('djwepay.fields.MoneyField')(max_digits=11, decimal_places=2))

        # Changing field 'Account.available_balance'
        db.alter_column('djwepay_account', 'available_balance', self.gf('djwepay.fields.MoneyField')(max_digits=11, decimal_places=2))

        # Changing field 'Account.pending_balance'
        db.alter_column('djwepay_account', 'pending_balance', self.gf('djwepay.fields.MoneyField')(max_digits=11, decimal_places=2))

        # Changing field 'Account.pending_amount'
        db.alter_column('djwepay_account', 'pending_amount', self.gf('djwepay.fields.MoneyField')(max_digits=11, decimal_places=2))
        # Deleting field 'Preapproval.shipping_address'
        db.delete_column(u'djwepay_preapproval', 'shipping_address_id')


        # Changing field 'Preapproval.tax'
        db.alter_column('djwepay_preapproval', 'tax', self.gf('djwepay.fields.MoneyField')(null=True, max_digits=11, decimal_places=2))

        # Changing field 'Preapproval.app_fee'
        db.alter_column('djwepay_preapproval', 'app_fee', self.gf('djwepay.fields.MoneyField')(max_digits=11, decimal_places=2))

        # Changing field 'Preapproval.amount'
        db.alter_column('djwepay_preapproval', 'amount', self.gf('djwepay.fields.MoneyField')(max_digits=11, decimal_places=2))

        # Changing field 'Preapproval.shipping_fee'
        db.alter_column('djwepay_preapproval', 'shipping_fee', self.gf('djwepay.fields.MoneyField')(null=True, max_digits=11, decimal_places=2))

        # Changing field 'Withdrawal.amount'
        db.alter_column('djwepay_withdrawal', 'amount', self.gf('djwepay.fields.MoneyField')(null=True, max_digits=11, decimal_places=2))
        # Deleting field 'Checkout.shipping_address'
        db.delete_column(u'djwepay_checkout', 'shipping_address_id')


        # Changing field 'Checkout.tax'
        db.alter_column('djwepay_checkout', 'tax', self.gf('djwepay.fields.MoneyField')(null=True, max_digits=11, decimal_places=2))

        # Changing field 'Checkout.gross'
        db.alter_column('djwepay_checkout', 'gross', self.gf('djwepay.fields.MoneyField')(null=True, max_digits=11, decimal_places=2))

        # Changing field 'Checkout.fee'
        db.alter_column('djwepay_checkout', 'fee', self.gf('djwepay.fields.MoneyField')(null=True, max_digits=11, decimal_places=2))

        # Changing field 'Checkout.app_fee'
        db.alter_column('djwepay_checkout', 'app_fee', self.gf('djwepay.fields.MoneyField')(null=True, max_digits=11, decimal_places=2))

        # Changing field 'Checkout.amount_refunded'
        db.alter_column('djwepay_checkout', 'amount_refunded', self.gf('djwepay.fields.MoneyField')(null=True, max_digits=11, decimal_places=2))

        # Changing field 'Checkout.amount'
        db.alter_column('djwepay_checkout', 'amount', self.gf('djwepay.fields.MoneyField')(null=True, max_digits=11, decimal_places=2))

    def backwards(self, orm):
        # Adding model 'Address'
        db.create_table(u'djwepay_address', (
        ...
        # Changing field 'Account.reserved_amount'
        db.alter_column('djwepay_account', 'reserved_amount', self.gf('djwepay.models.MoneyField')(max_digits=11, decimal_places=2))

        # Changing field 'Account.payment_limit'
        db.alter_column('djwepay_account', 'payment_limit', self.gf('djwepay.models.MoneyField')(null=True, max_digits=11, decimal_places=2))

        # Changing field 'Account.disputed_amount'
        db.alter_column('djwepay_account', 'disputed_amount', self.gf('djwepay.models.MoneyField')(max_digits=11, decimal_places=2))

        # Changing field 'Account.available_balance'
        db.alter_column('djwepay_account', 'available_balance', self.gf('djwepay.models.MoneyField')(max_digits=11, decimal_places=2))

        # Changing field 'Account.pending_balance'
        db.alter_column('djwepay_account', 'pending_balance', self.gf('djwepay.models.MoneyField')(max_digits=11, decimal_places=2))

        # Changing field 'Account.pending_amount'
        db.alter_column('djwepay_account', 'pending_amount', self.gf('djwepay.models.MoneyField')(max_digits=11, decimal_places=2))
        # Adding field 'Preapproval.shipping_address'
        db.add_column(u'djwepay_preapproval', 'shipping_address',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djwepay.Address'], null=True),
                      keep_default=False)


        # Changing field 'Preapproval.tax'
        db.alter_column('djwepay_preapproval', 'tax', self.gf('djwepay.models.MoneyField')(null=True, max_digits=11, decimal_places=2))

        # Changing field 'Preapproval.app_fee'
        db.alter_column('djwepay_preapproval', 'app_fee', self.gf('djwepay.models.MoneyField')(max_digits=11, decimal_places=2))

        # Changing field 'Preapproval.amount'
        db.alter_column('djwepay_preapproval', 'amount', self.gf('djwepay.models.MoneyField')(max_digits=11, decimal_places=2))

        # Changing field 'Preapproval.shipping_fee'
        db.alter_column('djwepay_preapproval', 'shipping_fee', self.gf('djwepay.models.MoneyField')(null=True, max_digits=11, decimal_places=2))

        # Changing field 'Withdrawal.amount'
        db.alter_column('djwepay_withdrawal', 'amount', self.gf('djwepay.models.MoneyField')(null=True, max_digits=11, decimal_places=2))
        # Adding field 'Checkout.shipping_address'
        db.add_column(u'djwepay_checkout', 'shipping_address',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['djwepay.Address'], null=True),
                      keep_default=False)


        # Changing field 'Checkout.tax'
        db.alter_column('djwepay_checkout', 'tax', self.gf('djwepay.models.MoneyField')(null=True, max_digits=11, decimal_places=2))

        # Changing field 'Checkout.gross'
        db.alter_column('djwepay_checkout', 'gross', self.gf('djwepay.models.MoneyField')(null=True, max_digits=11, decimal_places=2))

        # Changing field 'Checkout.fee'
        db.alter_column('djwepay_checkout', 'fee', self.gf('djwepay.models.MoneyField')(null=True, max_digits=11, decimal_places=2))

        # Changing field 'Checkout.app_fee'
        db.alter_column('djwepay_checkout', 'app_fee', self.gf('djwepay.models.MoneyField')(null=True, max_digits=11, decimal_places=2))

        # Changing field 'Checkout.amount_refunded'
        db.alter_column('djwepay_checkout', 'amount_refunded', self.gf('djwepay.models.MoneyField')(null=True, max_digits=11, decimal_places=2))

        # Changing field 'Checkout.amount'
        db.alter_column('djwepay_checkout', 'amount', self.gf('djwepay.models.MoneyField')(null=True, max_digits=11, decimal_places=2))
