...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WPCheckout.gross'
        db.alter_column('django_wepay_checkout', 'gross', self.gf('django_wepay.models_base.MoneyField')(null=True, max_digits=11, decimal_places=2))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'WPCheckout.gross'
        raise RuntimeError("Cannot reverse this migration. 'WPCheckout.gross' and its values cannot be restored.")
