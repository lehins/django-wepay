...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WPAddress.state'
        db.alter_column('django_wepay_address', 'state', self.gf('django_localflavor_us.models.USStateField')(max_length=2))

        # Changing field 'WPCheckout.fee'
        db.alter_column('django_wepay_checkout', 'fee', self.gf('django_wepay.models_base.MoneyField')(null=True, max_digits=11, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'WPAddress.state'
        db.alter_column('django_wepay_address', 'state', self.gf('django.contrib.localflavor.us.models.USStateField')(max_length=2))

        # User chose to not deal with backwards NULL issues for 'WPCheckout.fee'
        raise RuntimeError("Cannot reverse this migration. 'WPCheckout.fee' and its values cannot be restored.")
    ...
    models = {
        ...
        u'django_wepay.wpcheckout': {
            ...
            'preapproval': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['django_wepay.WPPreapproval']", 'unique': 'True', 'null': 'True'}),
